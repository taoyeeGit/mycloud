...
public class ConsulMain8000 {
    public static void main(String[] args) {
        SpringApplication.run(ConsulMain8000.class,args);
        System.out.println("consul client 消费者 8000 is started ===>>>");
    }
}
/*
eureka:
  instance:
    instance-id: cloud-rest-consul-service8000    #显示实例ID
